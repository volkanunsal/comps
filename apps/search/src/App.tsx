...
import { DataTable, type ColumnDef, type SortState } from "@repo/ui/components/data-table.js";
...
function App() {
	...
	// Pagination
	const totalPages = Math.max(1, Math.ceil(filteredAndSortedSongs.length / ITEMS_PER_PAGE));
